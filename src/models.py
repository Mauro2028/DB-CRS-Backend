...
class Worker(db.Model):
    ...
    catchment_source  = db.Column(db.String(120), unique=True, nullable=False)
    managment = db.Column(db.String(120), unique=True, nullable=False)
    vacant = db.Column(db.String(120), unique=True, nullable=False)
    branch_office = db.Column(db.String(120), unique=True, nullable=False)
    interview_date = db.Column(db.String(120), unique=True, nullable=False)
    Technical_Interview_date = db.Column(db.String(120), unique=True, nullable=False)
    salary_offer_date = db.Column(db.String(120), unique=True, nullable=False)
    preemployment_test_date = db.Column(db.String(120), unique=True, nullable=False)
    References_Check_date = db.Column(db.String(120), unique=True, nullable=False)
    admission_date = db.Column(db.String(120), unique=True, nullable=False)
    current_employment_contract = db.Column(db.String(120), unique=True, nullable=False)
    ...
    Salary_Aspirations = db.Column(db.String(120), unique=True, nullable=False)
    Academic_level = db.Column(db.String(120), unique=True, nullable=False)
    Place_of_residence = db.Column(db.String(120), unique=True, nullable=False)
    experience_years = db.Column(db.String(120), unique=True, nullable=False)
    availability = db.Column(db.String(120), unique=True, nullable=False)
    Current_courses = db.Column(db.String(120), unique=True, nullable=False)
    Software_Hardware_ERP_knowledge = db.Column(db.String(120), unique=True, nullable=False)
    know_someone_company = db.Column(db.Boolean(), unique=False, nullable=False)
    name_work_person = db.Column(db.String(120), unique=True, nullable=False)
    actual_charge = db.Column(db.String(120), unique=True, nullable=False)
    ...
    vacations = db.Column(db.String(120), unique=True, nullable=False)
    Vacation_Bonus = db.Column(db.String(120), unique=True, nullable=False)
    Factor = db.Column(db.String(120), unique=True, nullable=False)
    Estimated_annual_package = db.Column(db.String(120), unique=True, nullable=False)
    Mixed_mothly_compensation = db.Column(db.String(120), unique=True, nullable=False)
    ...
    Days_passed_Techinterview_entry = db.Column(db.String(120), unique=True, nullable=False)
    Days_passed_requisition_entry = db.Column(db.String(120), unique=True, nullable=False)
    Days_passed_open_status = db.Column(db.String(120), unique=True, nullable=False)
    Checking_Records_Detail = db.Column(db.String(120), unique=True, nullable=False)

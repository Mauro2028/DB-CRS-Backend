...
class Worker(db.Model):
    ...
    basic_salary = db.Column(db.String(120), unique=False, nullable=False)
    variable_salary = db.Column(db.String(120), unique=False, nullable=False)
    cesta_ticket = db.Column(db.String(120), unique=False, nullable=False)
    Monthly_Cash_Flow = db.Column(db.String(120), unique=False, nullable=False)
    Profit_Days = db.Column(db.String(120), unique=False, nullable=False)
    vacations = db.Column(db.String(120), unique=False, nullable=False)
    Vacation_Bonus = db.Column(db.String(120), unique=False, nullable=False)
    Factor = db.Column(db.String(120), unique=False, nullable=False)
    Estimated_annual_package = db.Column(db.String(120), unique=False, nullable=False)
    Mixed_mothly_compensation = db.Column(db.String(120), unique=False, nullable=False)
    Mixed_anual_compensation = db.Column(db.String(120), unique=False, nullable=False)
